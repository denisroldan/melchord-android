...
# EasyAdapter rules
-keepclassmembers class * extends com.aiculabs.easyadapter.ItemViewHolder {
    public <init>(...);
 }
...
-keepclassmembers class melchord.data.model.** {
...
-keepclassmembers class melchord.data.remote.RibotsService$** {
    !static !private <fields>;
}
